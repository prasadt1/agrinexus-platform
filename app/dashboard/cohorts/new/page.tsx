...
const PLANS: { id: PlanTier; name: string; price: string; desc: string }[] = [
  { id: "starter", name: "Starter", price: "₹999/mo", desc: "Up to 50 farmers in this cohort" },
  { id: "growth", name: "Growth", price: "₹2,999/mo", desc: "Up to 250 farmers in this cohort" },
  { id: "enterprise", name: "Scale", price: "₹9,999/mo", desc: "Up to 1,000 farmers, priority support" },
];
